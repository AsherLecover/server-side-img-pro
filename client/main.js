...
class ChatRoomComponent {
    ...
    getMessage(sender_id, resiver_id) {
        ...
        this.chatMessagesService.getMessages(sender_id, resiver_id).subscribe((data) => {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ChatRoomComponent, [{
    ...
    }], function () { return [{ type: _servises_private_area_service__WEBPACK_IMPORTED_MODULE_4__["PrivateAreaService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: src_app_servises_chat_messages_service__WEBPACK_IMPORTED_MODULE_5__["ChatMessagesService"] }]; }, null); })();
